...
The following variants are available: EXTNEDED\_SOURCE\_NOARC (no arc spectrum extracted), EXTENDED\_SOURCE\_NOFLAT (no division by a flat-field), EXTENDED\_SOURCE\_NOFLAT\_NOARC, EXTENDED\_SOURCE\_NOFLAT\_NOSTD, and EXTENDED\_SOURCE\_NOSTD.
