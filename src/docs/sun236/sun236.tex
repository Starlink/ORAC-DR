...
%  History:
%     $Log$
%     Revision 1.6  2001/12/14 02:58:16  timj
%     Wrong copyright
%
%     Revision 1.5  2001/12/14 02:53:06  timj
...
Historical data taken with the main historical recipes,
SOURCE\-\_PAIRS\-\_ON\_SLIT and SOURCE\-\_PAIRS\_TO\_SKY should now be reduced
with POINT\_SOURCE or EXTENDED\_SOURCE as appropriate. Use POINT\_SOURCE if in
douubt.
