...
%     2003 May (BRADC):
%        232.7: Updated for v4.0, including UIST.
...
United Kingdom Infrared Telescope (UKIRT) with the UFTI, UIST, IRCAM, and
...
\ORACDR\ for spectroscopy from CGS4, UIST and Michelle; \xref{SUN/246}{sun246}{}
...
YYYYMMDD.  Note that the \texttt{\%} represents the UNIX shell's
...
For UFTI, UIST, and IRCAM they comprise one NDF for the data
...
for the current UT date. For multi-mode instruments such as Michelle, UIST, or
...
follows: UFTI 26$e^{-}$, UIST 40$e^{-}$, IRCAM 47$e^{-}$, and IRIS2 15$e^{-}$.  Michelle reductions
...
500$e^{-}$ for Michelle, 15$e^{-}$ for UIST, and $\sim$5$e^{-}$ for IRIS2.
...
approximately 0.7\% of UFTI pixels, 0.4\% of UIST pixels,
0.1\% of IRCAM and IRIS2 pixels, and a preliminary 12 of Michelle's pixels.  
...
The variability of IRCAM, UIST, Michelle, and IRIS2 bad pixels is unknown at the
...
levels: 15000 for UFTI; 20000 for UIST, 20000 for IRCAM in STARE or NDSTARE mode, and
...
Flag all pixels that are 5 sigma above and below the 3-sigma clipped mean of the dark
...
using a broadened median, and the combined array normalised to a have a mean of
...
having at least 12 connected pixels above 1.0 sigma above sky.  The
...
jitter.  The exposure time (header EXP\_TIME [UFTI/UIST/Michelle], EXPOSED
[IRIS2], or
...
{\tt$<$instrument$>$} is {\tt UFTI}, {\tt UIST}, {\tt MICHELLE}, {\tt IRCAM}, or 
...
For IRCAM, Michelle, UIST, and UFTI, it's possible to edit the NDF's
...
\htmlref{NOD\_SKY\_FLAT\_THERMAL}{NOD\_SKY\_FLAT\_THERMAL} & &
   Nod jitter with interspersed sky frames. Sky subtraction, flat field
