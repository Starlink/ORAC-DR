...
\begin{center}
\includegraphics[width=1.0in]{sun232_logo}
\end{center}
% ? End of picture
...
bounds as given by headers {\tt ORAC\_X\_LOWER\_BOUND},
{\tt ORAC\_X\_UPPER\_BOUND}, {\tt ORAC\_Y\_LOWER\_BOUND},
{\tt ORAC\_Y\_UPPER\_BOUND}.  Suppose you wanted to trim off the top
