...
depending on the recipe.  The annulus is typically 7 to 15 arcseconds
...
\sstroutine{
   ...
   \sstnotes{
	 ...
	 that of the aperture (7.8 arcsec); the outer annulus is 2.5
	 times (15 arcsec) for UFTI and twice the aperture (12 arcsec)
...
\newpage
\section{\xlabel{se_changes}Release Notes---V2.0-1\label{se_changes}}
