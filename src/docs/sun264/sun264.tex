...
of the TC-shell to work correctly. The Starlink environment should be
...
the observation date in that form (e.g. 20100301). If the data is
...
\begin{myquote}
\begin{verbatim}
% picard -recpars <recipe_param_file> NAME_OF_RECIPE <list_of_files>
\end{verbatim}
\end{myquote}
where \verb+<recipe_param_file>+ is a text file containing the
relevant recipe parameters, \verb+NAME_OF_RECIPE+ is the name of the
