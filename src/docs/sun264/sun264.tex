...
\newcommand{\stardocversion}   {Version 1.2.0}
...
Chapin~E.~L., et al., 2013, \textit{SCUBA-2: iterative map-making with
  the Sub-Millimetre User Reduction Facility}, MNRAS, in press (arXiv:1301.3652)

\bibitem{scuba2calpaper}
Dempsey~J.~T. et al., 2013, \textit{SCUBA-2: on-sky calibration using
  submillimetre standard sources}, MNRAS, in press (arXiv:1301.3773)
\end{thebibliography}
...
\sstroutine{
   ...
   \sstnotes{
      This is the SUMMIT-specific version of the REDUCE\_SETUP recipe.
   }
   \sstdiytopic{
      Display
   }{
