...
\sstroutine{
   ...
   \sstdescription{
      A simple PICARD recipe to trim images from SCUBA-2 or ACSIS. The
      image may be trimmed using given spatial dimensions or a
      statistical estimator to threshold the image. In the former case,
      the output map is rectangular or circular; in the latter the shape
      is determined by the values in the image itself.
