...
\stardoccopyright {Copyright \copyright\ 2014--2015 Las Cumbres Observatory Global Telescope Inc.}

% Variable part - replace [xxx] as appropriate.
\stardocnumber    {269.4}
\stardocauthors   {Tim Lister \\
		    Las Cumbres Observatory}
\stardocdate	   {February 2015}
\stardoctitle     {ORAC-DR -- LCOGT pipeline data reduction}
\stardocversion   {0.4}
\stardocmanual    {User Guide}
\stardocabstract  {ORAC-DR is a general-purpose automatic data-reduction
pipeline environment.  This document describes its use to reduce optical imaging
data collected on the Las Cumbres Observatory Global Telescope Network (LCOGT).
}
...
\providecommand{\AASTROM}{\xref{\textsc{{AutoAstrom}}}{sun242}{}}
\providecommand{\ASTROM}{\xref{\textsc{{Astrom}}}{sun5}{}}
...
\providecommand{\JCMT}{\htmladdnormallink{JCMT}{http://www.eaobservatory.org/jcmt/}}
\providecommand{\UKIRT}{\htmladdnormallink{UKIRT}{http://www.ukirt.hawaii.edu/}}
...
\providecommand{\makebias}{\xref{\task{makebias}}{sun139}{MAKEBIAS}}
\providecommand{\makecal}{\xref{\task{makecal}}{sun139}{MAKECAL}}
\providecommand{\makeflat}{\xref{\task{makeflat}}{sun139}{MAKEFLAT}}
\providecommand{\debias}{\xref{\task{debias}}{sun139}{DEBIAS}}
\providecommand{\calcor}{\xref{\task{calcor}}{sun139}{CALCOR}}
\providecommand{\flatcor}{\xref{\task{flatcor}}{sun139}{FLATCOR}}
...
\providecommand{\LCOFull}{Las Cumbres Observatory Global Telescope Network}
\providecommand{\SAICD}{LCOGT-SA-ICD Version 0.10.0}
\providecommand{\SAICDFull}{LCOGT Pipeline/Science Archive Interface Control Document (LCOGT-SA-ICD Version 0.10.0)}
...
\section{\xlabel{introduction}Introduction\label{sec:intro}}

\ORACDR\ is a data-reduction pipeline operating at \UKIRT, \JCMT, the \AAT\  and
forms the basis of the operational pipeline at LCOGT. The pipeline reduces and
displays multi-frame observations soon after they are read from the detector. 
This allows observers to assess the quality and suitability of their data in
near real time but \ORACDR\ is also used to produce the final archive-delivered
products using the same code base.
...
This document describes how to use \ORACDR\ software on Starlink to reduce
optical imaging data from the \LCOFull\ (hereafter LCOGT; \cite{brown2013lcogt})
consists of data taken from one of the LCOGT instruments; \textsc{LCOSBIG},
\textsc{LCOCC}, \textsc{LCOSINISTRO}, \textsc{LCOSPECTRAL} or \textsc{LCOFLI}.
...
\section{\xlabel{pipelines}LCOGT Pipeline Variants\label{sec:pipelines}}
...
\subsection{\xlabel{envvars}Important environment variables\label{sec:envvars}}
...
be used to kill all DR-related processes, should you be having serious
problems.
...
\subsubsection{\xlabel{products}Output of derived products\label{sec:products}}
...
\subsubsection{\xlabel{timecorrect}Airmass and barycentric time
...
The recipe search path can also be overridden with an environment variable if
needed or a specific recipe to be run can be specified on the command line call
to \verb+oracdr+.
