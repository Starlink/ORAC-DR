...
%     - References to Kappa [sic] should be replaced with \KAPPA\
...
%  History:
%     $Log$
%     Revision 1.17  2001/11/26 01:56:41  mjc
%     Revise the credits to match the howto.
%
%     Revision 1.16  2001/11/26 00:17:05  mjc
%     Added two more xlabels and used a capital on named appencies and sections.
%
%     Revision 1.15  2001/11/25 03:36:11  mjc
%     Added some xlabels and it's KAPPA not Kappa.
%
%     Revision 1.14  2001/11/19 05:12:39  timj
%     missed an xlabel
%
%     Revision 1.13  2001/11/19 04:56:17  timj
%     left a document info in
%
%     Revision 1.12  2001/11/19 04:52:19  timj
%     Forgot some manpage references
%
%     Revision 1.11  2001/11/19 04:39:39  timj
%     Forgot the final tidy up
%
...
instruments UFTI, IRCAM, Michelle, and CGS4; and for the James Clerk
Maxwell Telescope (JCMT) instrument SCUBA. This document describes the
general pipeline environment. For specific information on how to
reduce the data for a particular instrument, please consult the
...
functions, see \xref{SUN/231}{sun230}{} for SCUBA,
\xref{SUN/232}{sun232}{} for IRCAM, UFTI, and Michelle imaging; and
\xref{SUN/236}{sun236}{} for CGS4 and Michelle spectroscopy.

\subsection*{What it is\label{Introduction_to_ORAC-DR_What_it_is}}

The \oracdr\ data reduction system is intended to be a pipeline
reducer for incoming data. It is in use for online data reduction at
UKIRT and JCMT for a variety of instruments. There are a number of
differences between the \oracdr\ method of reduction and other systems
currently in use and observers should not expect \oracdr\ to behave or
be used in the same way as those systems.
...
\section{\xlabel{jargon}Jargon\label{Jargon}}
...
\subsection*{What it means\label{ORAC-DR_What_it_means}}
\begin{description}
\item[pipeline] \mbox{}
...
\texttt{oracdisp} and the display system see Appendix~\ref{oracdisp}
and Appendix~\ref{The_ORAC-DR_Display_System}.
...
to the infrastructure of \oracdr.
...
Economou, Tim Jenness, Malcolm Currie, and Brad Cavanagh.  The
\oracdr\ GUI was added by Alasdair Allan (Starlink).
...
\item Easy to switch on variance creation and propagation; calculates
  correct data variance for UKIRT infra-red imagers.
