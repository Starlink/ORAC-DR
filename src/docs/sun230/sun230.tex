...
%  History:
%     $Log$
%     Revision 1.9  2001/04/12 02:47:44  timj
%     - add \xlabels
%     - add hyperlinks
%     - remove .eps from includegraphics lines
%
%     Revision 1.8  2001/04/11 03:52:25  timj
%     Add stardoccopyright
%
%     Revision 1.7  2001/04/11 02:09:56  timj
%     lowercase the section headings for Xoracdr
%
%     Revision 1.6  2001/04/10 23:57:18  timj
%     - V2.1-1
%     - Add xoracdr
%
...
\begin{center}
\includegraphics[width=1.0in]{sun230_logo}
\end{center}
% ? End of picture
...
\section{Introduction\label{Introduction_to_ORAC-DR}\index{Introduction to ORAC-DR}}
...
\xref{SUN/231}{sun231}{} for SCUBA and \xref{SUN/232}{sun232}{} for IRCAM and
UFTI.
...
\section{ORAC-DR Jargon\label{ORAC-DR_Jargon}\index{ORAC-DR Jargon}\xlabel{jargon}}
...
\end{description}
\begin{figure}
\includegraphics[width=\textwidth]{sun230_train}
\caption{What happens in ORAC-DR}
\end{figure}


%% ORACDRDOC_HOWTO:SettingUp
\section{Setting up to run oracdr\label{Setting_up_to_run_oracdr}\index{Setting up to run oracdr}\xlabel{setting_up}}
...
\section{ORAC-DR Components\label{ORAC-DR_Components}\index{ORAC-DR Components}\xlabel{components}}
...
\end{description}
\subsubsection*{Windows and output\label{oracdr_Windows_and_output}\index{oracdr!Windows and output}}\begin{description}
...
\section{Credit and License\label{Credit_And_Licence}\index{Credit and Licence}\xlabel{credits}}
...
\section{The ORAC-DR Data Loops\label{The_ORAC-DR_Data_Loops}\index{The ORAC-DR Data Loops}\xlabel{data_loops}}
...
\section{The ORAC-DR Display System\label{The_ORAC-DR_Display_System}\index{The ORAC-DR Display System}\xlabel{display_system}}
...
\section{The ORAC-DR Calibration Selection\label{The_ORAC-DR_Calibration_Selection}\index{The ORAC-DR Calibration Selection}\xlabel{calibrating}}
...
\section{Shell Variables\label{Shell_Variables}\index{Shell Variables}\xlabel{shell_variables}}
...
\section{oracdisp\label{oracdisp}\index{oracdisp}\xlabel{oracdisp}}
...
\section{oracdr\_nuke\label{oracdr_nuke}\index{oracdr\ nuke}\xlabel{oracdr_nuke}}
