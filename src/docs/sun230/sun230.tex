...
Sets up the data reduction system for INGRID in all observation modes.
...
Sets up the data reduction system for ESO ISAAC in imaging mode.
Support for spectroscopy mode is ongoing.
