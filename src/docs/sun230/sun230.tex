...
\newcommand{\stardocabstract} {\textsc{orac-dr} is a general purpose automatic
  ...
  and CGS4, for the James Clerk Maxwell Telescope (JCMT) instrument SCUBA and
...
\xref{SUN/231}{sun230}{} for SCUBA; \xref{SUN/232}{sun232}{} for IRCAM, UFTI,
Michelle and IRIS-2 imaging; and \xref{SUN/236}{sun236}{} for CGS4, Michelle
and IRIS-2 spectroscopy.
...
Support for UIST (UKIRT's infrared imaging spectrometer) and
the AAT's IRIS2 is also planned.
...
by Brad Cavanagh in conjunction with Stuart Ryder (AAT).
...
\oracdr\ is copyright \copyright 1998-2002 PPARC (the UK Particle Physics and Astronomy
