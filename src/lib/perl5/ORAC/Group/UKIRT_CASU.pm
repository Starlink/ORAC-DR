package ORAC::Group::UKIRT_CASU;

=head1 NAME

ORAC::Group::UKIRT_CASU - Base class for dealing with groups from UKIRT instruments with CASU modifications for FITS files.

=head1 SYNOPSIS

  use ORAC::Group::UKIRT_CASU;

  $Grp = new ORAC::Group::UKIRT_CASU;
...
ORAC::Group::UKIRT_CASU->_generate_orac_lookup_methods( \%hdr );
