package ORAC::Group::LCOSBIG;

=head1 NAME

ORAC::Group::LCOSBIG - class for dealing with LCOSBIG observation groups in ORAC-DR

=head1 SYNOPSIS

  use ORAC::Group::LCOSBIG;

  $Grp = new ORAC::Group::LCOSBIG("group1");
  $Grp->file("group_file")
  $Grp->readhdr;
...
are specific to LCOSBIG. It provides a class derived from B<ORAC::Group::NDF>.
All the methods available to ORAC::Group objects are available
to B<ORAC::Group::LCOSBIG> objects.
...
Create a new instance of a B<ORAC::Group::LCOSBIG> object.
This method takes an optional argument containing the
name of the new group. The object identifier is returned.

   $Grp = new ORAC::Group::LCOSBIG;
   $Grp = new ORAC::Group::LCOSBIG("group_name");
