package ORAC::Frame::LCOFLI;

=head1 NAME

ORAC::Frame::LCOFLI - class for dealing with LCO FLI 1.0m AG
observation files in ORAC-DR

This module provides methods for handling Frame objects that are
specific to FLI. It provides a class derived from
B<ORAC::Frame::LCO>.

=cut

# A package to describe a LCOFLI frame object for the
# ORAC pipeline
...
Create a new instance of a B<ORAC::Frame::LCOFLI> object.
...
The object identifier is returned.
   ...
   $Frm = new ORAC::Frame::LCOFLI;
   $Frm = new ORAC::Frame::LCOFLI("file_name");
   $Frm = new ORAC::Frame::LCOFLI("UT","number");
...
sub new {
  ...
  $self->rawfixedpart('lsc1m009-ef08-');
  $self->rawsuffix('.fits');
  $self->rawformat('FITS');
  $self->format('NDF');
