package ORAC::Frame::LCOCC;

=head1 NAME

ORAC::Frame::LCOCC - class for dealing with LCO CC observation files in ORAC-DR
...
# A package to describe a LCOCC group object for the
# ORAC pipeline
...
Create a new instance of a B<ORAC::Frame::LCOCC> object.
...
The object identifier is returned.
   ...
   $Frm = new ORAC::Frame::LCOCC;
   $Frm = new ORAC::Frame::LCOCC("file_name");
   $Frm = new ORAC::Frame::LCOCC("UT","number");
...
sub new {
  ...
  $self->rawfixedpart('lsc1m009-kb11-');
  $self->rawsuffix('.fits');
  $self->rawformat('FITS');
  $self->format('NDF');
