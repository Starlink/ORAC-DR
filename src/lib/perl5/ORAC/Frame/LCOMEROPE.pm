package ORAC::Frame::LCOMEROPE;

=head1 NAME

ORAC::Frame::LCOMEROPE - class for dealing with LCO MEROPE observation files in ORAC-DR

This module provides methods for handling Frame objects that are
specific to MEROPE. It provides a class derived from
B<ORAC::Frame::LCO>.

=cut

# A package to describe a LCOMEROPE group object for the
# ORAC pipeline
...
Create a new instance of a B<ORAC::Frame::LCOMEROPE> object.
...
The object identifier is returned.
   ...
   $Frm = new ORAC::Frame::LCOMEROPE;
   $Frm = new ORAC::Frame::LCOMEROPE("file_name");
   $Frm = new ORAC::Frame::LCOMEROPE("UT","number");
...
sub new {
  ...
  $self->rawfixedpart('ogg2m001-em01-');
  $self->rawsuffix('.fits');
  $self->rawformat('FITS');
  $self->format('NDF');
