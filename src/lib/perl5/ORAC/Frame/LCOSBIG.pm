package ORAC::Frame::LCOSBIG;

=head1 NAME

ORAC::Frame::LCOSBIG - class for dealing with LCO SBIG observation files in ORAC-DR
...
Create a new instance of a B<ORAC::Frame::LCOSBIG> object.
...
The object identifier is returned.
   ...
   $Frm = new ORAC::Frame::LCOSBIG;
   $Frm = new ORAC::Frame::LCOSBIG("file_name");
   $Frm = new ORAC::Frame::LCOSBIG("UT","number");
...
sub new {
  ...
  $self->rawfixedpart('elp1m008-kb76-');
  $self->rawsuffix('.fits');
  $self->rawformat('FITS');
  $self->format('NDF');
