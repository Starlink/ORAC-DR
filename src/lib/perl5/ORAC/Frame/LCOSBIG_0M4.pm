package ORAC::Frame::LCOSBIG_0M4;

=head1 NAME

ORAC::Frame::LCOSBIG_0M4 - class for dealing with LCO SBIG 0.4m observation
files in ORAC-DR
...
Create a new instance of a B<ORAC::Frame::LCOSBIG_0M4> object.
...
The object identifier is returned.
   ...
   $Frm = new ORAC::Frame::LCOSBIG_0M4;
   $Frm = new ORAC::Frame::LCOSBIG_0M4("file_name");
   $Frm = new ORAC::Frame::LCOSBIG_0M4("UT","number");
