...
are specific to old style CGS4. It provides a class derived from B<ORAC::Frame::UKIRT>.
...
#@ORAC::Frame::OCGS4::ISA = qw/ORAC::Frame::UKIRT/;
...
We get passed the prefix as YYYYMMDD, so have to strip off the 1st 2 digits
=cut
