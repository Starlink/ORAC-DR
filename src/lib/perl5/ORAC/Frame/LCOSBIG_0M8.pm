package ORAC::Frame::LCOSBIG_0M8;

=head1 NAME

ORAC::Frame::LCOSBIG_0M8 - class for dealing with LCO Sedgwick SBIG 0.8m
...
Create a new instance of a B<ORAC::Frame::LCOSBIG_0M8> object.
...
The object identifier is returned.
   ...
   $Frm = new ORAC::Frame::LCOSBIG_0M8;
   $Frm = new ORAC::Frame::LCOSBIG_0M8("file_name");
   $Frm = new ORAC::Frame::LCOSBIG_0M8("UT","number");
...
sub new {
  ...
  $self->rawfixedpart('sqa0m801-kb16-');
  $self->rawsuffix('.fits');
  $self->rawformat('FITS');
  $self->format('NDF');
