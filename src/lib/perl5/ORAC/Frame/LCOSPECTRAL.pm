package ORAC::Frame::LCOSPECTRAL;

=head1 NAME

ORAC::Frame::LCOSPECTRAL - class for dealing with LCO SPECTRAL (which is an 
imager, not a spectrograph...) observation files in ORAC-DR

This module provides methods for handling Frame objects that are
specific to SPECTRAL. It provides a class derived from
B<ORAC::Frame::LCO>.

=cut

# A package to describe a LCOSPECTRAL group object for the
# ORAC pipeline
...
Create a new instance of a B<ORAC::Frame::LCOSPECTRAL> object.
...
The object identifier is returned.
   ...
   $Frm = new ORAC::Frame::LCOSPECTRAL;
   $Frm = new ORAC::Frame::LCOSPECTRAL("file_name");
   $Frm = new ORAC::Frame::LCOSPECTRAL("UT","number");
...
sub new {
  ...
  $self->rawfixedpart('ogg2m001-fs02-');
  $self->rawsuffix('.fits');
  $self->rawformat('FITS');
  $self->format('NDF');
