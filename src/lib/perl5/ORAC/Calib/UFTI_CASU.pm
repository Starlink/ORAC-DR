package ORAC::Calib::UFTI_CASU;

=head1 NAME

ORAC::Calib::UFTI_CASU;

=head1 SYNOPSIS

  use ORAC::Calib::UFTI_CASU;

  $Cal = new ORAC::Calib::UFTI_CASU;
...
# @ORAC::Calib::UFTI_CASU::ISA = qw/ORAC::Calib/; # set up inheritance
...
Sub-classed constructor. Adds knowledge of linearity and confidence maps.
  ...
  my $Cal = new ORAC::Calib::UFTI_CASU;
