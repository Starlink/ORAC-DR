package ORAC::Inst::ISAAC;

=head1 NAME

ORAC::Inst::ISAAC - ORAC description of ISAAC
...
ISAAC uses KAPPA (kappa_mon), FIGARO, CCDPACK, PHOTOM, and POLPACK amongst
others.
...
sub start_algorithm_engines {
  ...
  my @engines = orac_determine_initial_algorithm_engines( 'ISAAC' );
