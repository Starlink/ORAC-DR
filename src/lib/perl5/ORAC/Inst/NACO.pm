package ORAC::Inst::NACO;

=head1 NAME

ORAC::Inst::NACO - ORAC-DR description of NACO
...
NACO uses KAPPA (kappa_mon), FIGARO, CCDPACK, PHOTOM, and POLPACK amongst
others.
...
sub start_algorithm_engines {
  ...
  my @engines = orac_determine_initial_algorithm_engines( 'NACO' );
