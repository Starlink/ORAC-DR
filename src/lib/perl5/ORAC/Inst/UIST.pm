package ORAC::Inst::UIST;

=head1 NAME

ORAC::Inst::UIST - ORAC description of UIST
...
UIST uses KAPPA (kappa_mon), FIGARO, CCDPACK, PHOTOM, and POLPACK amongst
others.
...
sub start_algorithm_engines {
  ...
  my @engines = orac_determine_initial_algorithm_engines( 'UIST' );
...
sub return_possible_calibrations {
  my $self = shift;
  return ( "arc", "bias", "dark", "flat", "grism", "mask", "sky", "standard", "arlines", "badobs", "iar", "offset", "profile", "readnoise", "row", "referenceoffset" );
