package ORAC::Inst::SWFCAM;

=head1 NAME

ORAC::Inst::SWFCAM - ORAC description of WFCAM using Starlink software
for reduction

=head1 SYNOPSIS

  use ORAC::Inst::SWFCAM;
...
sub start_algorithm_engines {
  ...
  my @engines = orac_determine_initial_algorithm_engines("SWFCAM");
