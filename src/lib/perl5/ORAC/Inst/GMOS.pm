package ORAC::Inst::GMOS;

=head1 NAME

ORAC::Inst::GMOS - ORAC description of GMOS
...
GMOS uses KAPPA (kappa_mon), FIGARO and CCDPACK.
...
sub start_algorithm_engines {
  ...
  my @engines = orac_determine_initial_algorithm_engines( 'GMOS' );
