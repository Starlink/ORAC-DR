package ORAC::Inst::Michelle;

=head1 NAME

ORAC::Inst::Michelle - ORAC description of Michelle

=head1 SYNOPSIS

  use ORAC::Inst::Michelle;
...
Michelle uses KAPPA (kappa_mon), FIGARO, CCDPACK, PHOTOM, and POLPACK amongst
others.
...
sub start_algorithm_engines {
  ...
  my @engines = orac_determine_initial_algorithm_engines( 'MICHELLE' );
...
sub return_possible_calibrations {
  my $self = shift;
  return ( "arc", "bias", "dark", "flat", "mask", "sky", "standard", "badobs", "baseshift", "profile", "readnoise", "row", "referenceoffset" );
