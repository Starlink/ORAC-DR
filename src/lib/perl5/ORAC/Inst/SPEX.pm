package ORAC::Inst::SPEX;

=head1 NAME

ORAC::Inst::SPEX - ORAC description of SPEX
...
SPEX uses PHOTOM (photom_mon), CCDPACK (ccdpack_red, ccdpack_res, 
...
sub start_algorithm_engines {
  ...
  my @engines = orac_determine_initial_algorithm_engines( 'SPEX' );
