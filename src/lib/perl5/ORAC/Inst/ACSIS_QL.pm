package ORAC::Inst::ACSIS_QL;

=head1 NAME

ORAC::Inst::ACSIS_QL - ORAC description of ACSIS quick-look.

=head1 SYNOPSIS

  use ORAC::Inst::ACSIS_QL;
...
# Retrieve algorithm requirements.
  my @engines = orac_determine_initial_algorithm_engines( 'ACSIS_QL' );
