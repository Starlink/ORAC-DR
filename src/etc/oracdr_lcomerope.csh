...
#  Purpose:
#     Initialise ORAC-DR environment for use with LCO Merope 2.0M imager

#  Language:
#     C-shell script

#  Invocation:
#     source ${ORAC_DIR}/etc/oracdr_lcomerope.csh

#  Description:
#     This script initialises the environment variables and command
#     aliases required to run the ORAC-DR pipeline with LCO MEROPE data.
...
#        is set to $ORAC_CAL_ROOT/lcomerope` If ORAC_CAL_ROOT is not
...
#     oracdr_lcomerope 20120314 em01
#        Use UT data 20120314 for camera em01
...
#  Revision:
#     $Id: oracdr_lcomerope.csh 7423 2014-01-18 00:07:17Z tlister $
...
setenv ORAC_INSTRUMENT LCOMEROPE-$argv[2]
