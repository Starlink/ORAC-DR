...
#  Invocation:
#     source ${ORAC_DIR}/etc/oracdr_wfcam1.sh
...
#  History:
#     $Log$
#     Revision 1.2  2006/11/15 20:00:32  bradc
#     change ukirt_sw and/or jcmt_sw to jac_sw
#
#     Revision 1.1  2006/10/03 00:20:01  bradc
#     replaced with ex-SWFCAM version
#
#     Revision 1.2  2006/09/07 00:35:26  bradc
#     fix for proper bash scripting
#
#     Revision 1.1  2006/09/06 02:30:14  bradc
#     initial addition
#
...
export ORAC_DATA_IN=$ORAC_DATA_ROOT/raw/wfcam1/$oracut
export ORAC_DATA_OUT=$ORAC_DATA_ROOT/reduced/wfcam1/$oracut
