...
#  Invocation:
#     source ${ORAC_DIR}/etc/oracdr_sofi.sh
...
export ORAC_INSTRUMENT=SOFI
export ORAC_DATA_IN=$ORAC_DATA_ROOT/raw/sofi/$oracut
export ORAC_DATA_OUT=$ORAC_DATA_ROOT/reduced/sofi/$oracut
export ORAC_DATA_CAL=$ORAC_CAL_ROOT/sofi
