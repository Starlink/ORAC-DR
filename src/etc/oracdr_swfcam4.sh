...
#  Invocation:
#     source ${ORAC_DIR}/etc/oracdr_swfcam4.sh
...
#
#     Revision 1.1  2006/09/06 02:30:19  bradc
#     initial addition
#
...
export ORAC_INSTRUMENT=SWFCAM4
export ORAC_DATA_IN=$ORAC_DATA_ROOT/raw/wfcam4/$oracut
export ORAC_DATA_OUT=$ORAC_DATA_ROOT/reduced/wfcam4/$oracut
