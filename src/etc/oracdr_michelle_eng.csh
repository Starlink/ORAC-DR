...
#  Purpose:
#     Initialise ORAC-DR environment for use with Michelle engineering

#  Language:
#     C-shell script

#  Invocation:
#     source oracdr_michelle_eng.csh
...
#     $ORAC_DATA_ROOT/raw/eng/michelle/<UT> for the "raw" data, and
#     $ORAC_DATA_ROOT/reduced/eng/michelle/<UT> for the "reduced" data.
...
# Define input and output data, and calibration directories.
    ...
    setenv ORAC_DATA_IN  $ORAC_DATA_ROOT/raw/eng/michelle/$oracut
    setenv ORAC_DATA_OUT $ORAC_DATA_ROOT/reduced/eng/michelle/$oracut
