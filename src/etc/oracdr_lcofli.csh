...
#  Purpose:
#     Initialise ORAC-DR environment for use with LCO FLI 1.0M

#  Language:
#     C-shell script

#  Invocation:
#     source ${ORAC_DIR}/etc/oracdr_lcofli.csh

#  Description:
#     This script initialises the environment variables and command
#     aliases required to run the ORAC-DR pipeline with LCO FLI data.
...
#        is set to $ORAC_CAL_ROOT/lcofli` If ORAC_CAL_ROOT is not
...
#     oracdr_lcofli 20120314 ef06
#        Use UT data 20120314 for camera ef06
...
setenv ORAC_INSTRUMENT LCOFLI-$argv[2]
