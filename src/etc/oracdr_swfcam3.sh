...
#  Invocation:
#     source ${ORAC_DIR}/etc/oracdr_swfcam3.sh
...
#
#     Revision 1.1  2006/09/06 02:30:17  bradc
#     initial addition
#
...
export ORAC_INSTRUMENT=SWFCAM3
export ORAC_DATA_IN=$ORAC_DATA_ROOT/raw/wfcam3/$oracut
export ORAC_DATA_OUT=$ORAC_DATA_ROOT/reduced/wfcam3/$oracut
