...
#  Purpose:
#     Initialise ORAC-DR environment for use with UIST engineering

#  Language:
#     C-shell script

#  Invocation:
#     source oracdr_uist.csh
...
#     $ORAC_DATA_ROOT/raw/eng/uist/<UT> for the "raw" data, and
#     $ORAC_DATA_ROOT/reduced/eng/uist/<UT> for the "reduced" data.
...
setenv ORAC_DATA_IN  $ORAC_DATA_ROOT/raw/eng/uist/$oracut
setenv ORAC_DATA_OUT $ORAC_DATA_ROOT/reduced/eng/uist/$oracut
