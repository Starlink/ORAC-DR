...
#
#     Revision 1.1  2006/09/06 02:30:23  bradc
#     initial addition
#
...
export ORAC_DATA_IN=$ORAC_DATA_ROOT/ufti_data/$oracut/raw/
export ORAC_DATA_OUT=$ORAC_DATA_ROOT/ufti_data/$oracut/reduced/
