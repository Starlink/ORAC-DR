...
#  Purpose:
#     Initialise ORAC-DR environment for use with LCO Context Cameras (CC)

#  Language:
#     C-shell script

#  Invocation:
#     source ${ORAC_DIR}/etc/oracdr_lcocc.csh

#  Description:
#     This script initialises the environment variables and command
#     aliases required to run the ORAC-DR pipeline with LCO CC data.
...
#        is set to $ORAC_CAL_ROOT/lcocc` If ORAC_CAL_ROOT is not
