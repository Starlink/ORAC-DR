...
#  Purpose:
#     Initialise ORAC-DR environment for use with ACSIS quick-look cubes.

#  Language:
#     sh shell script

#  Invocation:
#     source ${ORAC_DIR}/etc/oracdr_acsis_ql.sh
...
#  History:
#     $Log$
#     Revision 1.1  2006/11/15 19:43:06  bradc
#     initial addition
#
...
# Instrument
export ORAC_INSTRUMENT=ACSIS_QL
