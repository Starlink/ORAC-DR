...
#  Purpose:
#     Initialise ORAC-DR environment for use with CGS4

#  Language:
#     sh shell script

#  Invocation:
#     source ${ORAC_DIR}/etc/oracdr_cgs4.sh
...
#  History:
#     $Log$
#     Revision 1.3  2006/11/15 20:00:23  bradc
#     change ukirt_sw and/or jcmt_sw to jac_sw
#
#     Revision 1.2  2006/09/07 00:35:17  bradc
#     fix for proper bash scripting
#
#     Revision 1.1  2006/09/06 02:29:50  bradc
#     initial addition
#
...
export ORAC_DATA_OUT=$ORAC_DATA_ROOT/reduced/cgs4/$oracut
export ORAC_DATA_CAL=$ORAC_CAL_ROOT/cgs4
