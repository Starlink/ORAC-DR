...
#  Purpose:
#     Initialise ORAC-DR environment for use with LCO SINISTRO 1.0M

#  Language:
#     C-shell script

#  Invocation:
#     source ${ORAC_DIR}/etc/oracdr_lcosinistro.csh

#  Description:
#     This script initialises the environment variables and command
#     aliases required to run the ORAC-DR pipeline with LCO SINISTRO data.
...
#        is set to $ORAC_CAL_ROOT/lcosinistro` If ORAC_CAL_ROOT is not
...
#     oracdr_lcosinistro 20120314 kb16
...
setenv ORAC_INSTRUMENT LCOSINISTRO-$argv[2]
