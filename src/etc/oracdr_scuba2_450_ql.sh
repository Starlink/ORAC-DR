...
#  Invocation:
#     source ${ORAC_DIR}/etc/oracdr_scuba2_450_ql.sh
...
if test -n $ORAC_DATA_CAL; then
  alias xstripchart="${STARLINK_DIR}/bin/starperl ${STARLINK_DIR}/Perl/bin/xstripchart -cfg=$ORAC_DATA_CAL/jcmt_450_ql.ini -title='SCUBA2_450 QL' &"
fi
