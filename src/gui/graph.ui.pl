...
# from /home/timj/oracdr/gui/graph.ui
...
sub graph_ui {
	...
	my($suffixentry) = $root->Entry (
		-textvariable => \$STATUS{GRAPH}{SUFFIX},
		-width => '8',
	);
	...
	my($toolmenu) = $root->Menubutton (
		-relief => 'ridge',
		-text => 'no',
		-textvariable => \$STATUS{GRAPH}{TOOL},
		-width => '10',
	);
	...
	my($windowmenu) = $root->Menubutton (
		-relief => 'ridge',
		-text => 'no',
		-textvariable => \$STATUS{GRAPH}{WINDOW},
	);
	...
	my($regionmenu) = $root->Menubutton (
		-relief => 'ridge',
		-text => 'no',
		-textvariable => \$STATUS{GRAPH}{REGION},
	);
	...
	my($radiobutton_1) = $root->Radiobutton (
		-text => 'Autoscale',
		-value => '1',
		-variable => \$STATUS{GRAPH}{XAUTOSCALE},
	);
	...
	my($entry_2) = $root->Entry (
		-textvariable => \$STATUS{GRAPH}{XMIN},
		-width => '12',
	);
	...
	my($entry_5) = $root->Entry (
		-textvariable => \$STATUS{GRAPH}{XMAX},
		-width => '12',
	);
	...
	my($radiobutton_3) = $root->Radiobutton (
		-text => 'Autoscale',
		-value => '1',
		-variable => \$STATUS{GRAPH}{YAUTOSCALE},
	);
	...
	my($entry_3) = $root->Entry (
		-textvariable => \$STATUS{GRAPH}{YMIN},
		-width => '12',
	);
