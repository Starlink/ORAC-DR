...
# from /home/timj/oracdr/gui/datamodel.ui
...
sub datamodel_ui {
	...
	my($suffixentry) = $root->Entry (
		-textvariable => \$STATUS{DATAMODEL}{SUFFIX},
		-width => '8',
	);
	...
	my($toolmenu) = $root->Menubutton (
		-relief => 'ridge',
		-text => 'no',
		-textvariable => \$STATUS{DATAMODEL}{TOOL},
		-width => '10',
	);
	...
	my($windowmenu) = $root->Menubutton (
		-relief => 'ridge',
		-text => 'no',
		-textvariable => \$STATUS{DATAMODEL}{WINDOW},
	);
	...
	my($regionmenu) = $root->Menubutton (
		-relief => 'ridge',
		-text => 'no',
		-textvariable => \$STATUS{DATAMODEL}{REGION},
	);
	...
	my($radiobutton_1) = $root->Radiobutton (
		-text => 'Autoscale',
		-value => '1',
		-variable => \$STATUS{DATAMODEL}{XAUTOSCALE},
	);
	...
	my($entry_2) = $root->Entry (
		-textvariable => \$STATUS{DATAMODEL}{XMIN},
		-width => '12',
	);
	...
	my($entry_5) = $root->Entry (
		-textvariable => \$STATUS{DATAMODEL}{XMAX},
		-width => '12',
	);
