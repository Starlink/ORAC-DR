...
sub contour_ui {
	...
	my($suffixentry) = $root->Entry (
		-textvariable => \$STATUS{CONTOUR}{SUFFIX},
		-width => '8',
	);
	...
	my($toolmenu) = $root->Menubutton (
		-relief => 'ridge',
		-text => 'no',
		-textvariable => \$STATUS{CONTOUR}{TOOL},
		-width => '10',
	);
	...
	my($windowmenu) = $root->Menubutton (
		-relief => 'ridge',
		-text => 'no',
		-textvariable => \$STATUS{CONTOUR}{WINDOW},
	);
	...
	my($regionmenu) = $root->Menubutton (
		-relief => 'ridge',
		-text => 'no',
		-textvariable => \$STATUS{CONTOUR}{REGION},
	);
	...
	my($radiobutton_1) = $root->Radiobutton (
		-text => 'Autoscale',
		-value => '1',
		-variable => \$STATUS{CONTOUR}{XAUTOSCALE},
	);
	...
	my($entry_2) = $root->Entry (
		-textvariable => \$STATUS{CONTOUR}{XMIN},
		-width => '12',
	);
	...
	my($entry_5) = $root->Entry (
		-textvariable => \$STATUS{CONTOUR}{XMAX},
		-width => '12',
	);
	...
	my($radiobutton_3) = $root->Radiobutton (
		-text => 'Autoscale',
		-value => '1',
		-variable => \$STATUS{CONTOUR}{YAUTOSCALE},
	);
	...
	my($entry_3) = $root->Entry (
		-textvariable => \$STATUS{CONTOUR}{YMIN},
		-width => '12',
	);
	...
	my($entry_6) = $root->Entry (
		-textvariable => \$STATUS{CONTOUR}{YMAX},
		-width => '12',
	);
	...
	my($radiobutton_4) = $root->Radiobutton (
		-text => 'Autoscale',
		-value => '1',
		-variable => \$STATUS{CONTOUR}{ZAUTOSCALE},
	);
	...
	my($entry_4) = $root->Entry (
		-textvariable => \$STATUS{CONTOUR}{ZMIN},
		-width => '12',
	);
	...
	my($entry_7) = $root->Entry (
		-textvariable => \$STATUS{CONTOUR}{ZMAX},
		-width => '12',
	);
	...
	my($entry_8) = $root->Entry (
		-textvariable => \$STATUS{CONTOUR}{NCONT},
		-width => '12',
	);
	...
	$button_8->configure(
		-command => sub {modify_current('CONTOUR')}
	);
	$button_4->configure(
		-command => sub { &set_default_status('CONTOUR'); }
	);
	$button_7->configure(
		-command => sub {&add_entry('CONTOUR') }
	);
...
create_menus('CONTOUR', $toolmenu, $windowmenu, $regionmenu);
